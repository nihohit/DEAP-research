...
numOfMovies = 40;
resultArrayLength = numOfChannels * numOfBands + 1;
...
for participantsIndex = 1:numOfParticipants
    ...
    participantResult =  participantsResults(participantsIndex, numOfLabels, numOfChannels, numOfBands, numOfMovies);
    ...
    for labelIndex = 1:numOfLabels 
        ...
        for i = 1:numOfRelevantResults
            ...
            relevantParticipantResult(i,1:resultArrayLength - 1) = participantResult(relevantResults(i), numOfLabels + 1:numOfChannels * numOfBands + numOfLabels);
        end
